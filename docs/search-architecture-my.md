...
[data/scripts/update-emoji.ts](/Users/heink/v0-burmese-emoji-search-su/data/scripts/update-emoji.ts) က locale တစ်ခုစီအတွက် runtime dataset ထုတ်ပေးပါတယ်။
...
ပြီးရင် [buildBurmeseSearchMetadata()](/Users/heink/v0-burmese-emoji-search-su/lib/burmese-search.ts) က `wordTokens` ကို ဒီလိုထုတ်ပါတယ်:
...
Semantic search ကို လောလောဆယ် Burmese မှာပဲ ဖွင့်ထားပါတယ်။
...
ဒီအတွက် recovered concept phrase တွေ အရေးကြီးပါတယ်။ Burmese query အရှည်တစ်ခုမှာ raw sentence embedding တစ်ခုတည်းထက် `သဲကန္တာရ`, `ကားမောင်း` လို concept view တွေက ပိုအသုံးဝင်တတ်ပါတယ်။
